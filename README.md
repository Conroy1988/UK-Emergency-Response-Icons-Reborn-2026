...
**A complete, compact mission-marker pack for MissionChief UK.** Every current
official mission gets a clear incident pictogram, a permanent **TKB Response
Level 1–5**, and native red/amber/green map-state graphics.
...
- **Red** — new mission or action still required.
- **Amber** — response under way.
- **Green** — required resources covered/on scene.
